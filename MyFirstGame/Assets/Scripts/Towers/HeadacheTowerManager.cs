...
public class HeadacheTowerManager : TowerManager
{
    [SerializeField]
    ...
    [SerializeField]
    private HeadacheEffect StarEffect;
    ...
    {
        return new HeadacheDebuff(TargetMonster, tickTime, tickDamage, DebuffDuration, StarEffect);
    }
    ...
    public override string GetStats()
    {
        ...
        return $"<color=#ffa500ff><size=20><b>Headache</b></size></color>\n{base.GetStats()}\nTick Time: {tickTime}\nTick Damage: {tickDamage}";
    }
